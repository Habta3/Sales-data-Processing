...
'''
This section performs data Preprocessing
'''
class Data_Preprocessing:
    ...
    def extract_fields_date(self, df, date_column):
        ...
        try:
            ...
            df['weekday'] = pd.DatetimeIndex(df[date_column]).weekday
            df['weekofyear'] = pd.DatetimeIndex(df[date_column]).weekofyear
            df['weekend'] = pd.DatetimeIndex(df[date_column]).apply(self.is_weekend)
